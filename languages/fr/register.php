...
%pagetitle% - %homepage_url%',
	...
	'enter_password2' => 'Le mot de passe doit répondre aux critères suivants: Longueur: min. 6 caractères, un certain nombre, un petit et majuscules, un caractère spécial'
