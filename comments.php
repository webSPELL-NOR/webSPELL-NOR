...
$name = getnickname($userID, $id);
    ...
    $msgfrom= array();
    $msgfrom[ 'ne' ] = "zu einem Newsbeitrag";
    $msgfrom[ 'ar' ] = "zu einem Artikel";
    $msgfrom[ 'ga' ] = "zu einem Foto";
    $msgfrom[ 'cw' ] = "zu einem Clanwars";
    $msgfrom[ 'de' ] = "zu einer Demo";
    $msgfrom[ 'po' ] = "zu einer Umfrage";
...
$message = '[br]Hallo Member,[br][br]' . $name . ' hat gerade ein Kommentar ' . $_message_from . ' gepostet.[br][br][URL=' . $_POST[ 'referer' ] . '][i]Klicke Hier um zu dem Eintrag zu gelangen.[/i][/url]';
