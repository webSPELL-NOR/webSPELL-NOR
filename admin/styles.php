  ...
  <script>  jQuery(function($) { $('#cp1').colorpicker(); }); 
          ...
          jQuery(function($) { $('#cp17').colorpicker(); }); </script>
...
echo '<div class="panel panel-default">
  <div class="panel-heading">
    ...
    <li role="presentation" class="active"><a href="/admin/admincenter.php?site=styles">Style</a></li>
    <li role="presentation"><a href="/admin/admincenter.php?site=buttons">Buttons</a></li>
    <li role="presentation"><a href="/admin/admincenter.php?site=moduls">Module</a></li>
