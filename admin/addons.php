...
if ($action == "add") {
    ...
    <div class="panel-heading">
                            <i class="fa fa-bars"></i> ' . $_language->module[ 'addons' ] . '
                        </div>
    <div class="panel-body">
    <a href="admincenter.php?site=addons" class="white">' . $_language->module[ 'addons' ] .
    ...
    echo '<form class="form-horizontal" method="post" action="admincenter.php?site=addons">
